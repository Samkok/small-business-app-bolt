  ...
  return (
    ...
    >
      ...
      <Section title="9. Limitation of Liability">
        ...
        <Paragraph>
          9.3. Business Decisions: We are not liable for business decisions made based on Application data or reports.
        </Paragraph>
        <Paragraph>
          9.4. Maximum Liability: Our total liability shall not exceed the amount paid by you for the Application in the twelve months preceding the claim.
        </Paragraph>
      </Section>

      <Section title="10. Data Backup and Security">
        <Paragraph>
      ...
      <Section title="12. Modifications to Service">
        <Paragraph>
      ...
      <Section title="13. Multi-Language Support">
        <Paragraph>
