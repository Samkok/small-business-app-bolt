/*
  ...
  1. Schema Changes
    ...
    - Rename primary key and check constraints
    - Update all foreign key references to the renamed table
    
  2. Indexes
    - Rename index for user_id to reflect new table name
    
  3. Security
    - Temporarily disable RLS during schema changes
    - Re-enable RLS after changes (policies updated in later migration)
*/
...
-- Rename the role check constraint
