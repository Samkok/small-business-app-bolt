/*
# Add auth.uid() guard to get_full_subscription_state

## Problem
- Any authenticated user can call get_full_subscription_state with any user ID
  and learn their subscription tier, status, expiration, business count, etc.

## Changes
- Added auth.uid() check at the top of the function
