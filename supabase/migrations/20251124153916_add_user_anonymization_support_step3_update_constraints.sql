/*
  # User Anonymization Support - Step 3: Update Foreign Key Constraints
...
-- Step 3.1: Update carts.created_by constraint
...
-- Step 3.2: Update sales.created_by constraint
...
-- Step 3.3: Update expenses.created_by constraint
...
-- Step 3.4: Update inventory_imports.imported_by constraint
...
-- Step 3.5: Update inventory_batches.imported_by constraint
...
-- Step 3.6: Update sale_actions.performed_by constraint
...
-- Step 3.7: Add explicit constraint for products.archived_by
