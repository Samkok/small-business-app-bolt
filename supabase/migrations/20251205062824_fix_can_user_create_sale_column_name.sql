/*
  # Fix column name in can_user_create_sale function
  
  ## Changes
  - Update can_user_create_sale to use correct column name `owner_user_id` instead of `owner_id`
  - Fix references in both ownership check and business ordering query
*/
